# Salai — Claude Code Instructions

## Project Identity

**Salai** (Leonardo da Vinci's apprentice) — Game editor for kiran — egui visual editor, inspector, hierarchy, viewport, gizmos
...
kiran users (scene editing tool)
